pub fn merge(nums1: &mut [i32], m: i32, nums2: &[i32], n: i32) {
    ...
    // Place final sorted values in nums1 array.
    // Notice that the largest values are at
    // the back of each array.
    // Start from the back of each array to compare elements.
    ...
    // Compare and merge.
    // Use nums2 as the exist condition.
    while idx2 >= 0 {
